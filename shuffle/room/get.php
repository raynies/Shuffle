...
**************************************************/
	...
	// 設定
	$api_key = 'LzpNfJYTGWfGAohLR31Fe1g2Z' ;		// APIキー
	$api_secret = 'Y9cBzYj4Gjp8b0afBWn2mVYzXXPGaq9S4wiDq8vTdNWtUl2isO' ;		// APIシークレット
	$access_token = '726104751318786049-SOPW8SBmzaHdo5ADJUAKCCXDlwTnh7s' ;		// アクセストークン
	$access_token_secret = 'WOBNC0PWJ0CcVvSPk88rBbGx3tTTClUYwAx5DwxTAmjSw' ;		// アクセストークンシークレット
...
//	}
	...
	echo "<img src='".$obj["profile_image_url"]."' />";
	print_r($obj["name"]) ;